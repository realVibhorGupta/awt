/*
 * ListDataEventDemo.java is a 1.4 example that requires the
 * Java Look and Feel Graphics Repository (jlfgr-1_0.jar). 
 * You can download this file from
 * http://developer.java.sun.com/developer/techDocs/hi/repository/.
 * The applet tag in 
 * http://java.sun.com/docs/books/tutorial/uiswing/events/ListDataEventDemo.atag
 * refers to this file.
 */
...
public class ListDataEventDemo extends JApplet 
    ...
    public void init() {
        ...
        upButton = new JButton(createImageIcon("Up16"));
        upButton.setMargin(new Insets(0,0,0,0));
        upButton.setActionCommand(upString);
        upButton.addActionListener(new UpDownListener());

        downButton = new JButton(createImageIcon("Down16"));
